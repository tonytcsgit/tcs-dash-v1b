...
class OperationsBrowser(unittest.TestCase):
    def test_demo_layout_metrics_navigation_and_no_live_requests(self):
        ...
        with sync_playwright() as pw:
            ...
            self.assertEqual(current, ['SMA — BP and Parker equally important; Pulaski lower priority.', 'WDC — Parker budget.', 'IL JDC — BP budget.', 'Chlorpyrifos — BP.', 'Rideshare — BP.'])
            self.assertIn('As of September 12',page.locator('#lawsuit-priorities').inner_text())
